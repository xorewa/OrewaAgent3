...
DEFAULT_AGENT_IDENTITY = (
    "You are Orewa Agent 3, an independent coding assistant configured for Xiaomi MiMo. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on Orewa Agent 3, a Hermes-derived agent fork. When the user needs help with "
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot Orewa Agent 3 itself — its CLI, config, models, providers, tools, "
